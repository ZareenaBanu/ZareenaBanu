...
public class ReadABConactListUploadinSMSExcelFirstNameJohn {
  ...
  for(ch = 'A'; ch <= 'Z'; ++ch) {
   ...
   csvFilePropName  = "JOHN All Contacts From AB FirstName-"+ch+"-"+((String) (java.time.LocalDate.now()+"-"+java.time.LocalTime.now()).subSequence(0, 19)).replace(":","-");
 ...
 //page.locator("xpath=/html/body/div[4]/div[1]/div/div[2]/p/a/i").click(); 
   //page.click("a[class='banner-close']");
      ...
      page.click("input[id='element_4_1_0_0_0']"); //Click on FirstName Text box
      
      page.fill("input[id='element_4_1_0_0_0']", StringChr);
      Thread.sleep(8000); 
