...
public class ReadABContactSuburbUploadinSMSExcelTJ {
  public static void main(String[] args) throws IOException, InterruptedException, CsvValidationException {
    ...
    String _inputFileABSuburbs = "C:\\Users\\P128DEF\\OneDrive - Ceridian HCM Inc\\MyFolder\\Zar-Per\\TJ\\Auto\\InputFile-ABSuburbs.csv";
    ...
    try (Playwright playwright = Playwright.create()) {
      ...
      try (BufferedReader reader = new BufferedReader(
        ...
        while ((tempStr = reader.readLine()) != null) {
          ...
          csvFilePropName = "TJ Contacts Suburb - " + _suburbGroup + " - "
