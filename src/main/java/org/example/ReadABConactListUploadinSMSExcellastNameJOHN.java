...
public class ReadABConactListUploadinSMSExcellastNameJOHN {
  ...
  for(ch = 'A'; ch <= 'Z'; ++ch) {
   ...
   csvFilePropName  = "JOHN All Contacts From AB LastName-"+ch+"-"+((String) (java.time.LocalDate.now()+"-"+java.time.LocalTime.now()).subSequence(0, 19)).replace(":","-");
