...
public class ReadABConactListUploadinSMSExcelFirstName {
  ...
  for(ch = 'A'; ch <= 'Z'; ++ch) {
   ...
   csvFilePropName  = "Tariq All Contacts From AB FirstName-"+ch+"-"+((String) (java.time.LocalDate.now()+"-"+java.time.LocalTime.now()).subSequence(0, 19)).replace(":","-");
